...
/* ================================================================== */
/*  Peripheral initializers (private)                                 */
/* ================================================================== */
...
{
    /* ---- Enable clocks ---- */
    RCC->AHB1ENR |= RCC_AHB1ENR_GPIOBEN    /* PB (SCK, CS)    */
...
/**
 * @brief  Configure I2C1 at 100 kHz
 *
 *  Pin mapping
 *  ───────────
 *  PB6 → SCL (AF4, I2C1_SCL)
