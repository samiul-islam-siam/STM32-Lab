# STM32 Dino Game (HAL) 🦕
A Chrome Dino-style game running on a 16x2 LCD, built with STM32F446RE Nucleo board using STM32CubeMX and STM32CubeIDE.
...
- LCD 1602A (HD44780 compatible, 16x2)
...
3. Flash with **Run → Debug** via onboard ST-Link
4. Adjust potentiometer until characters are clearly visible
